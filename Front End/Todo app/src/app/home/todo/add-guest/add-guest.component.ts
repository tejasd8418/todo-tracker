...
export class AddGuestComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.todoService.addGuest(guest, this.data.emailId, this.data.categoryId,  this.data.todoId).subscribe(data => {
      console.log(data);
    });
  ...
  this.guestService.saveTodo(this.data, guest.guestEmailId, category1.categoryId).subscribe(data=>{
    console.log(data);
  })
